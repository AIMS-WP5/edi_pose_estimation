...
def get_ground_truth_pose():
    pose = np.array([
        [-1.000, 0.016, 0.004, 0.012],
        [-0.016,-0.955,-0.295, 0.019],
        [-0.001,-0.295, 0.955, 0.290],
        [0.000, 0.000, 0.000, 1.000]
    ])
    pose_bottle = np.array([
        [0.000, 0.000, 1.000, -0.070],
        [0.000, 1.000, 0.000, 0.000],
        [-1.000, 0.000, 0.000, 0.017],
        [0.000, 0.000, 0.000, 1.000]
    ])
    pose = pose @ pose_bottle
    tvec = pose[:3, 3]
...
def camera_setup():
    ...
    # config.enable_device_from_file("/home/arnis/aims/rotation_predict/20260306_162957.bag")
    config.enable_device_from_file("/home/arnis/aims/rotation_predict/20260306_145443.bag")
...
def main():
    ...
    try:
        ...
        while True:
            ...
            res_est_list = est.estimate(color, depth_raw, K, do_viz=True)
            ...
            if res_est:
                ...
                tvec_ee, rvec_ee = get_ground_truth_pose()
                cv2.drawFrameAxes(axes_img, K, dist_coeffs, rvec_ee, tvec_ee, 0.05, 2)
