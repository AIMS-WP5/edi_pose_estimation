    ...
    try:
        ...
        while True:
            ...
            if res_est:
                ...
                position_rez = 0.001 * np.array(res_est["tvec"]) # no mm uz m
                ...
                pose_msg = Pose()
                pose_msg.position.x = position_rez[0]
                pose_msg.position.y = position_rez[1]
                pose_msg.position.z = position_rez[2]
